...
os.popen("vmd -dispdev text -e vmd.tcl\n");
os.popen("tachyon structure.dat -o curve.bmp -format BMP -res 1050 1050\n");
...
os.popen("tachyon territory.dat -o chull.bmp -format BMP -res 1050 1050\n");
